...
import java.sql.Statement;
    ...
    public void gerarSiteEstoque() throws ClassNotFoundException, java.sql.SQLException, InterruptedException {
        ...
        try (java.io.PrintWriter writer = new java.io.PrintWriter(caminhoArquivo, "UTF-8");
            ...
            writer.println("  </div>");
            // ==========================================
            // JAVASCRIPT COMPLETO (COM NOTIFICAÇÃO)
            // ==========================================
            ...
            writer.println("");
            writer.println("    // ========================================");
            writer.println("    // FINALIZAR COMPRA (COM NOTIFICAÇÃO PARA O SISTEMA)");
            writer.println("    // ========================================");
            ...
            writer.println("");
            writer.println("      // ==========================================");
            writer.println("      // 🔥 NOTIFICAR O SISTEMA DESKTOP");
            writer.println("      // ==========================================");
            ...
            writer.println("      };");
            writer.println("");
            writer.println("      console.log('📤 Notificando sistema...', dadosNotificacao);");
            writer.println("");
            ...
            writer.println("              alert('✅ Pagamento confirmado!');");
