...
public class GerarSiteEstoque {
    ...
    public void gerarSiteEstoque() throws ClassNotFoundException, java.sql.SQLException, InterruptedException {
        ...
        try (java.io.PrintWriter writer = new java.io.PrintWriter(caminhoArquivo, "UTF-8");
            ...
            writer.println("        const marca = produto.marca || ''; // 🔥 PEGA A MARCA");
            writer.println("        ");
            writer.println("        // 🔥 CRIA O data-busca COM NOME, CÓDIGO, TAMANHO E MARCA");
            ...
            writer.println("        }");
            writer.println("        ");
            writer.println("        // 🔥 ADICIONA O ATRIBUTO data-busca NO CARD");
