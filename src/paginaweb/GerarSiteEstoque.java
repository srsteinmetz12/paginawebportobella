...
//            writer.println("      }");
            ...
            writer.println("          if (codigoElement) {");
            writer.println("            let texto = codigoElement.textContent;");
            writer.println("            console.log('📝 Card com código:', texto);");
            writer.println("            if (texto.includes(codPeca)) {");
            ...
            writer.println("                };");
            writer.println("");
            writer.println("                console.log('📤 Notificando sistema desktop...', dadosNotificacao);");
            writer.println("");
